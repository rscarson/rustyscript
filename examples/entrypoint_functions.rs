...
/// 
use js_playground::{Runtime, Script, Error, Undefined, RuntimeOptions};
...
fn main() -> Result<(), Error> {
    ...
    let internal_value: usize = runtime.call_function(&module_handle, "getValue", Runtime::EMPTY_ARGS)?;
