...
|`import_provider` |Enables importing arbitrary code from anywhere by implementing a trait                                     |**NO**†           |None                                                                                           |
|                  |                                                                                                           |                  |                                                                                               |
...
† Your implementation may still preserve sandboxing if you only allow importing JS/TS code that you trust. Exercise caution.
