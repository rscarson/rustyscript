use crate::{
    ...
    ext,
    module_loader::{ImportHandler, RustyLoader},
...
pub struct InnerRuntimeOptions {
    ...
    /// Optional hashmap of extra ImportHandlers
    #[cfg(feature = "custom_import")]
    pub extra_import_handlers: Option<HashMap<String, Box<ImportHandler>>>,
